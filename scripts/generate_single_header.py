"""
    ...
    Usage:
        ...
        e.g. python3 generate_single_header.py -i include/boost/reflecto/detail/all.hpp -p include -o test/reflecto.hpp boost/reflecto
...
def _main():
    ...
    with open(tmp_file_name, 'w') as tmp_file, open(args.input, 'r') as input_file:
        ...
        if args.hash:
            tmp_file.write(
                ' from https://github.com/zajo/reflecto/tree/' + args.hash[0:7])
        tmp_file.write(
            '.\n'
            '\n'
            '// Copyright 2026 Emil Dotchevski\n'
