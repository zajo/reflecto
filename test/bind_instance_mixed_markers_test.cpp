...
int main()
{
    CHECK((bind_instance<setting<resolve_for<ns_a::a_type1>>>::value == 1000));

    CHECK((bind_instance<setting<resolve_for<ns_a::a_type2>>>::value == 10));

    CHECK((bind_instance<setting<resolve_for<ns_a::ns_b::b_type>>>::value == 20));

    CHECK((bind_instance<setting<resolve_for<ns_other::other_type>>>::value == -1));
